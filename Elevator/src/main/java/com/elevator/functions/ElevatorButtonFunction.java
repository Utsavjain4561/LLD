...
public class ElevatorButtonFunction implements Function<FloorEnum, ElevatorButton<NumberButton>> {
    @Override
    public ElevatorButton<NumberButton> apply(FloorEnum floorEnum) {
        val numberButton = new NumberButton(floorEnum, ButtonTypeEnum.ELEVATOR_BUTTON);
